...
angular.module('icons')
	.controller('uploadController', ["$scope", "$rootScope", "userService", "Upload", "$http", function($scope, $rootScope, userService, Upload, $http) {
...
angular.module('icons')
  .controller('iconsListCtrl', ["$scope", "$rootScope", "dataService", "$state", "$http", function ($scope, $rootScope, dataService, $state, $http) {
    ...
    dataService.getALlIcons().then(function(icons) {
      $scope.icons = icons;
    },function(error) {
    	$rootScope.$broadcast('iconsDisplayMessage', {
    		type: "alert",

...
angular.module('icons')
    ...
    userAPI.getCurrentSessionToken = getCurrentSessionToken;
      ...
      if (token === null) {
        ...
        return $http.post('/auth/token', {}, headers).then(function(res) {
          debugger;
        }, function(error) {
          debugger;
        })

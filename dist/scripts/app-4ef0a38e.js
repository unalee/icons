...
angular.module('icons')
  .controller('iconsListCtrl', ["$scope", "$rootScope", "$routeParams", "$state", "$http", function ($scope, $rootScope, $routeParams, $state, $http) {

  	$scope.icons = [];
  	$scope.icon = {};
  	//$scope.loading = true;

    $http.get('/api/icon/all').success(function(icons) {
      $scope.icons = icons;
      $scope.$apply();
    }).error(function() {
    	$rootScope.$broadcast('iconsDisplayMessage', {
...
angular.module('icons')
  .controller('iconDetailCtrl', ["$scope", "$rootScope", "$routeParams", "$state", "$http", function ($scope, $rootScope, $routeParams, $state, $http) {

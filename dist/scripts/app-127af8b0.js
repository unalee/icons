...
angular.module('icons')
	.controller('uploadController', ["$scope", "$rootScope", "userService", "Upload", "$http", "$state", function($scope, $rootScope, userService, Upload, $http, $state) {
...
.directive('iconsActivityIndicator', function() {
	return {
    	restrict: 'E',
      templateUrl: '/loader/loader.directive.html'
  	};
});
...
angular.module('icons')
  .controller('iconsListCtrl', ["$scope", "$rootScope", "dataService", "$state", "$http", function ($scope, $rootScope, dataService, $state, $http) {
...
angular.module('icons')
  .controller('iconDetailCtrl', ["$scope", "$rootScope", "$stateParams", "dataService", "$http", function ($scope, $rootScope, $stateParams, dataService, $http) {
...
$templateCache.put("app/loader/loader.directive.html","<div class=\"loader-mask\"><div class=\"loader\"><div class=\"dot\"></div><div class=\"dot\"></div><div class=\"dot\"></div></div></div>");
